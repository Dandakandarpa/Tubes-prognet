...
<div class="nk-fmg-body-head d-none d-lg-flex">
    ...
    <div class="nk-fmg-actions">
        <div class="btn-group">
            <a href="{{ route('crud4.create', ['id' => $id, $nama ]) }}" class="btn btn-sm btn-primary" onclick="buttondisable(this)"><em class="icon fas fa-plus"></em> <span>Add Data</span></a>
        </div>
    </div>
</div>
                ...
                <div class="table-responsive">
                    <table id="{{$table_id}}" class="small-table table " style="width:100%">
                        <thead style="color:#526484; font-size:11px;" class="thead-light">
                            ...
                            <th width="10%">Nama Kursus</th>
                            <th width="10%">Tempat</th>
                            <th width="10%">Jumlah Jam</th>
                            <th width="10%">Tangal Kursus</th>
                            <th width="10%">Aksi</th>
                            <th width="10%"></th>
                        </thead>
                        <tbody></tbody>
