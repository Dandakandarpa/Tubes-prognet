...
<div class="nk-fmg-body-head d-none d-lg-flex">
    ...
    <div class="nk-fmg-actions">
        <div class="btn-group">
            <a href="{{ route('crud3.create') }}" class="btn btn-sm btn-primary" onclick="buttondisable(this)"><em class="icon fas fa-plus"></em> <span>Add Data</span></a>
        </div>
    </div>
</div>
                ...
                <div class="table-responsive">
                    <table id="{{$table_id}}" class="small-table table " style="width:100%">
                        <thead style="color:#526484; font-size:11px;" class="thead-light">
                            ...
                            <th width="10%">Nama Diklat</th>
                            <th width="10%">Jenis Diklat</th>
                            <th width="10%">Aksi</th>
                        </thead>
                        <tbody></tbody>
                    </table>
...
$(document).ready(function() {
    table = $('#{{$table_id}}').DataTable({
        ...
        columns: [
            ...
            {
                data: 'pilihjenisdiklat.nama_jenis_diklat',
